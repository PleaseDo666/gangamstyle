...
# 7. Working with Lit Actions

Developers can utilize Lit Actions to introduce signing automation to their web3 apps. Below, we will illustrate some examples and potential use cases. In order to explore all that Lit Actions have to offer, check out the official [SDK documentation](https://actions-docs.litprotocol.com/).
