...
Lit’s [Programmable Key Pairs (PKPs)](/programmableKeyPairs/intro) product can be utilized by app developers to build a white-label MPC wallet solution that delivers a more flexible and seamless onboarding experience to their end users. 
...
You can read more about how authentication works with PKPs in [this section](/programmableKeyPairs/authHelpers) of the docs.
