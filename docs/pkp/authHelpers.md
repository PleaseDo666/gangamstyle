...
You will also need the PKP public key in order to generate a [sessionSig](/SDK/Explanation/authentication/sessionSigs) which is required to communicate with the Lit nodes, as seen in this [example](https://github.com/LIT-Protocol/oauth-pkp-signup-example/blob/main/src/App.tsx#L413). 
