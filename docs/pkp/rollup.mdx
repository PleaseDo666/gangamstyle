...
To connect to Chronicle, you'll need to use the RPC URL: https://chain-rpc.litprotocol.com

This will allow you to interact with the rollup and perform transactions using the Lit Test Token. You can also add Chronicle to your Metamask by clicking this button: <AddRollupButton />
